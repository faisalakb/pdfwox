...
export function SiteHeader({ navCategories }: { navCategories: NavCategory[] }) {
  return (
    <header className="sticky top-0 z-30 border-b border-[var(--color-hero-line)] bg-[var(--color-hero-bg)]">
      <Container className="flex h-16 items-center justify-between gap-6">
        ...
        {/* Desktop nav — pure CSS hover, no hydration needed */}
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Mobile hamburger + drawer — the only client island in the header */}
          <MobileMenuClient navCategories={navCategories} />
        </div>
      </Container>
    </header>
  );
